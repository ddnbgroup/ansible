...
class VaultLib:
    ...
    def is_encrypted(self, data):
        ...
        :arg data: a byte str or unicode string to test whether its is
            recognized as vault encrypted data
        :returns: True is it is recognized.  Otherwise, False.
        """
    ...
    def decrypt(self, data):
        ...
        :returns: a unicode type string containing the decrypted data
        """
        b_data = to_bytes(data, errors='strict', encoding='utf-8')
        ...
        data = this_cipher.decrypt(b_data, self.b_password)
        if data is None:
            raise AnsibleError("Decryption failed")

        return to_unicode(data, errors='strict')
